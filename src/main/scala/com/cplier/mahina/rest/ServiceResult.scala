...
object ServiceResult {
  val UnexpectedFailure: ErrorMessage =
...
object ErrorMessage {
  val InvalidEntityId: ErrorMessage = ErrorMessage("invalid.entity.id", Some("No matching entity found"))
  val InvalidAuthOp: ErrorMessage   = ErrorMessage("invalid.auth.op", Some("Authorization fail"))
}
